...
class PurchOrderDetails extends Model
{
    /**
    ...
    protected $table      = 'purchorderdetails';
    protected $primaryKey = 'podetailitem';
    protected $fillable   = ['podetailitem', 'orderno', 'itemcode', 'deliverydate', 'itemdescription', 'glcode', 'qtyinvoiced', 'unitprice', 'actprice', 'stdcostunit', 'quantityord', 'quantityrecd', 'shiptref', 'jobref', 'completed', 'suppliersunit', 'suppliers_partno', 'assetid', 'conversionfactor'];
