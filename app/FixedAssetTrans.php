...
class FixedAssetTrans extends Model
{
    /**
    ...
    protected $table      = 'fixedassettrans';
    protected $primaryKey = 'id';
    protected $fillable   = ['id', 'assetid', 'transtype', 'transdate', 'transno', 'periodno', 'inputdate', 'fixedassettranstype', 'amount'];
