...
class SalesManRepository implements SalesManRepositoryInterface
{
    ...
    //名称是否重复
    public function isRepeat($salesmanname, $smantel)
    {
        return SalesMan::where('salesmanname', $salesmanname)->where('smantel', $smantel)->where('status', '1')->first();
    }
}
