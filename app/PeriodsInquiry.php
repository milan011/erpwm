...
class PeriodsInquiry extends Model
{
    /**
    ...
    protected $primaryKey = 'periodno';
    protected $fillable   = ['periodno', 'lastdate_in_period'];
    ...
    // 定义PeriodsInquiry表与Notice表一对多关系
